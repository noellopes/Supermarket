...
namespace Supermarket.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TicketId,PrintDate,TicketNumber,TicketState,DepartmentId,ClientCard")] Tickets tickets)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TicketId,PrintDate,TicketNumber,TicketState,DepartmentId,ClientCard")] Tickets tickets)
        {
