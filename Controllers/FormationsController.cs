...
namespace Supermarket.Controllers
{
    public class FormationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FormationId,PontuacaoFormation,PontucaoAtribuida,EmployeeId")] Formation formation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FormationId,PontuacaoFormation,PontucaoAtribuida,EmployeeId")] Formation formation)
        {
