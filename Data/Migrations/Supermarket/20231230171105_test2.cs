...
namespace Supermarket.Data.Migrations.Supermarket
{
    ...
    public partial class test2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubsidyCalculation_SubsidySetup_SubsidySetupId",
                        column: x => x.SubsidySetupId,
                        principalTable: "SubsidySetup",
                        principalColumn: "SubsidySetupId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubsidyCalculation_SubsidySetupId",
                table: "SubsidyCalculation",
                column: "SubsidySetupId");
